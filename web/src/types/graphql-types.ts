...
export type SanityFeatureTextOrFeatureTextGroupOrFormOrImageComparisonOrInlineImageOrProductGroupOrRichTextOrVimeo =
  | SanityFeatureText
...
export type SanityHeroButton = {
  ...
  _type?: Maybe<Scalars['String']>;
  text?: Maybe<Scalars['String']>;
  link?: Maybe<SanityPageReference>;
};
...
export type SanityHeroButtonFilterInput = {
  ...
  link?: Maybe<SanityPageReferenceFilterInput>;
};
...
export type SanityPage = SanityDocument &
  Node & {
    ...
    modules?: Maybe<
      Array<
        Maybe<
          SanityFeatureTextOrFeatureTextGroupOrFormOrImageComparisonOrInlineImageOrProductGroupOrRichTextOrVimeo
        >
      >
    >;
